...
router
    ...
    .post('/send-verify-email-to-user', function (req, res, next) {
        ...
        var mailOptions = {
            ...
            subject: 'EatoEato-Email Verification', // Subject line
            text: 'Please Verify Your Email Account', // plain text body
            html: '<b> Please Click on Below Link to Verify your Account</b> <br><br> <a href="https://www.eatoeato.com/#/verify-user-params/' + req.body.user_id + '/' + req.body.email + '">' + randomstring.generate({ length: 100, charset: 'alphabetic' }) + '</a>' // html body
        };
        ...
        db.user_infos.find({
            ...
            if (err || user == "") {
                ...
                var mailOptions = {
                    ...
                    html: '<b> Please Click on Below Link to Reset your Account Password</b> <br><br><br> <a href="https://eatoeato.com/#/user_login' + user._id + '">' + randomValueHex(100) + '</a>' // html body
                };
        ...
        db.cook_infos.find({ isApproved: 'Approved' }, {
            ...
            for (var i = 0; i < cook_final_list_coll.length; i++) {
                ...
                for (var j = 0; j < cook_final_list_coll[i].food_details.length; j++) {
                    ...
                    if (cook_final_list_coll[i].food_details[j].food_isApproved == 'Approved' && cook_final_list_coll[i].food_details[j].food_status == 'Enable' && cook_final_list_coll[i].isDeactivate == 'false' && cook_final_list_coll[i].is_cook_commission_approved == 'accept') {
...
router
    .post('/get-payu-data', function (req, res, next) {
        ...
        console.log(req.body);
        res.redirect('https://www.eatoeato.com/user/payu-test' + req.body);
    })
...
router
    .post('/payu-process', function (req, res, next) {
        ...
        if (req.body.status == 'failure') {
            ...
            res.redirect('https://www.eatoeato.com/#/payment/failure');
        ...
        if (req.body.status == 'success') {
            ...
            res.redirect('https://www.eatoeato.com/#/payment/success');
...
router
    .post('/payu-wallet-process', function (req, res, next) {
        ...
        if (req.body.status == 'failure') {
            ...
            res.redirect('https://www.eatoeato.com/#/my_wallet');

    ...
    db.cook_infos.save(
        {
            ...
            token: '',
            device_type: '',
            is_cook_commission_approved: 'false',
        ...
        , function (err, cook_details) {
            ...
            var mailOptions = {
                ...
                html: '<b>Your Account Has Been Created by, Please Click on Below Link to Verify your Account</b> <br> <a href="https://eatoeato.com/#/verify-user-params/">' + randomstring.generate({ length: 100, charset: 'alphabetic' }) + '</a>' // html body
            };
            ...
            , function (err, cook) {
                ...
                if (err) {
                    ...
                    dns.lookup(os.hostname(), function (err, add, fam) {
                        ...
                        img_obj.food_img = add + '/uploads/cook_uploads/raw/' + img_name + '.jpg';
...
module.exports.send_verify_email_to_cook = function (req, res, next) {
    ...
    db.cook_infos.find({
        ...
        _id: mongojs.ObjectId(req.body.cook_id),
            ...
            var email_href = 'https://www.eatoeato.com/#/verify-cook-params/' + req.body.cook_id + '/' + req.body.email;
                                ...
                                db.notification_infos.save(
                                    {
                                        ...
                                        message: userdata[0].username + " ,Your Order #" + order_id + " has been confirmed.",
                                        seenstatus: '0',
...
module.exports.fetch_commission_info = function (req, res, next) {

    console.log('FETCHING COOK COMMISSION');
    console.log(req.body);
    var cookid = req.body.cook_id;

    db.cook_infos.find({ '_id': mongojs.ObjectId(cookid) }, { is_cook_commission_approved: 1, cook_commission: 1 }, function (err, cookdata) {
...
module.exports.commission_approved_by_cook = function (req, res, next) {
        ...
        db.cook_infos.findAndModify(
            {
                ...
                query: {
                    '_id': mongojs.ObjectId(cookid)
                },
                update: {
                    $set: {
                        is_cook_commission_approved: 'accept',
        ...
        db.cook_infos.findAndModify(
            {
                ...
                update: {
                    $set: {
                        is_cook_commission_approved: 'reject',
